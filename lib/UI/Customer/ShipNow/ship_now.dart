...
class SelectType1 extends StatefulWidget {
  const SelectType1({Key? key}) : super(key: key);

  @override
  State<SelectType1> createState() => _SelectType1State();
}

class _SelectType1State extends State<SelectType1> {
