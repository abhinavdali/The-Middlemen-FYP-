...
class DriverNavigate extends StatefulWidget {
  DriverNavigate({required this.dest});
  final dest;

  @override
  State<DriverNavigate> createState() => _DriverNavigateState();
}

class _DriverNavigateState extends State<DriverNavigate> {
  ...
  void initState() {
    super.initState();
    _getCurrentLocation();
    destinationAddressController.text = widget.dest;
    _destinationAddress = widget.dest;
  }
